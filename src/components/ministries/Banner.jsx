...
import contactimg from "../../assets/ministries/ministries-banner.jpg";
  ...
  return (
    <div className="relative h-[500px]" style={bgStyle}>
      ...
      <div className="flex flex-col items-center justify-center gap-5 h-full w-full relative z-10">
        <p className="text-3xl md:text-5xl font-firasanscondensed font-semibold text-center text-white">{"Ministries".toUpperCase()}</p>
